...
<template>
  <Container class="border-t border-neutral-300 dark:border-neutral-600 py-16 space-y-6 text-center bg-white-700 dark:bg-darkTheme">
    ...
    <SociaLink />
    <h2 class="text-gray-600 text-sm">Totally not copyrighted © Kevin Sandiho 2022</h2>
  </Container>
</template>
