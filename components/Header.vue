  ...
  >
    ...
    >
      ...
      <div class="flex items-center">
        ...
        >
          <ion-icon
            :name="$colorMode.preference === 'light' ? 'sunny' : $colorMode.preference === 'dark' ? 'moon' : 'contrast'"
        ...
        <div class="sm:hidden flex item-center">
          <button @click="() => (menu = !menu)" class="w-8 h-8 ml-2 mr-1 rounded">
          ...
          >
            <nav
              @click="menu = !menu"
              class="flex flex-col space-y-4 items-center font-display text-xl font-semibold h-full mt-8"
            >
